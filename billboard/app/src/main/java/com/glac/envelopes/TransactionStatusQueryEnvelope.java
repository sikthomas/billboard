 ...
 */
public class TransactionStatusQueryEnvelope extends BaseEnvelope {

    public TransactionStatusQueryEnvelope(String merchantId, String password, String timestamp, String transactionId, String merchantTransactionId) {
        //Header
        ...
        XMLParentNode processCheckOutRequest = getBody().addNode(
                getTnsNamespace(), "transactionStatusRequest");
        //Optional
