...
import com.glac.classes.ChowderSOAPRequester;
import com.glac.data.Subscription;
import com.glac.ecommerce.PostAdapter;
import com.glac.ecommerce.PostItemDesc;
import com.glac.envelopes.ProcessCheckoutEnvelope;
import com.glac.envelopes.TransactionConfirmEnvelope;
import com.glac.envelopes.TransactionStatusQueryEnvelope;
import com.glac.interfaces.PaymentListener;
import com.glac.responses.ProcessCheckoutResponse;
import com.glac.responses.TransactionConfirmResponse;
import com.glac.responses.TransactionStatusQueryResponse;
...
public class Chowder {
    ...
    public Chowder(Activity activity, String merchantId, String passkey, PostItemDesc paymentCompleteListener) {
        this.paymentCompleteListener = (PaymentListener) paymentCompleteListener;
