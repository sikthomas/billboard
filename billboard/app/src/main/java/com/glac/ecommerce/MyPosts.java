...
public class MyPosts extends Fragment {
    ...
    private View view;
    private List<PotsItemMyPosts> potsItems;
    private PostAdapterMyPosts postAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        postAdapter = new PostAdapterMyPosts(potsItems);
        ...
        Query query = firebaseFirestore.collection("HotDeals").whereEqualTo("user_id",current_user_id).orderBy("timeStamp", Query.Direction.DESCENDING);
            ...
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                ...
                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                    ...
                    if (doc.getType() == DocumentChange.Type.ADDED) {
                        ...
                        PotsItemMyPosts postItem = doc.getDocument().toObject(PotsItemMyPosts.class).withId(postID);
